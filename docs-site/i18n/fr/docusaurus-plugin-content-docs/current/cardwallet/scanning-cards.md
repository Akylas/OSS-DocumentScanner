...
La fonctionnalité de scan de codes-barres est implémentée dans :

| Composant | Emplacement |
|-----------|-------------|
| Scanner de Codes-Barres | `app/components/qrcode/` |
| Traitement des Codes-Barres | `zxingcpp/` |
| Service de Cartes | `app/services/qrcode.ts` |

:::tip
CardWallet utilise la bibliothèque ZXing pour le scan de codes-barres, qui supporte une grande variété de formats et fonctionne hors ligne.
:::
