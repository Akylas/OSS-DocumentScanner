...
constructor(private val context: Context, private val cropView: CropView? = null) :
        ...
        companion object {
                ...
                /**
                 * take a photo with a document, crop everything out but document, and force it to
                ...
                fun cropDocument(
                        ...
                        quadsFromJSONString(quads)!!.forEachIndexed { index, quad ->
                                ...
                                val cropWidth =
                                                ((corners.topLeftCorner.distance(
        ...
        override fun process(
                ...
                try {
                        ...
                        var previewBitmap = BitmapUtils.getBitmap(context, imageProxy)
                        // Log.d(
                        //                 "JS",
                        //                 "created previewBitmap " +
