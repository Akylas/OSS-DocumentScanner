...
<gridlayout borderColor={colorOutline} borderRadius={8} borderWidth={1} columns="auto,auto,auto" height={32} margin={4} paddingLeft={rightIcon ? 8 : 12} paddingRight={8} {...$$restProps}>
    ...
    <mdbutton col={2} color={colorOnSurface} fontFamily={$fonts.mdi} fontSize={16} marginLeft={4} padding={0} text="mdi-close" variant="text" verticalAlignment="middle" width={20} on:tap />
</gridlayout>
