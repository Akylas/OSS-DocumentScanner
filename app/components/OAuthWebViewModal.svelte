<script lang="ts">
    import { WebView } from '@nativescript-community/ui-webview';
    ...
    let webView: NativeViewElementNode<WebView>;
    let loading = true;
...
<page bind:this={page} actionBarHidden={true} id="oauthwebview">
